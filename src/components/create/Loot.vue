<template>
    <!-- 약탈 컴포넌트 -->
    <div
        v-for="(loot, index) in childList"
        :key="index"
        class="verticalFlex lootWrap"
    >
        <div class="horizontalFlex">
            ...
            <div class="buttonWrap">
                <button
                    @click="
                        unionStorage.togglePop('loot', loot, index, 'insert')
                    "
                >
                    타겟 추가
                </button>
        ...
        <div class="verticalFlex subWrap">
            <!-- 타겟 하위 그룹 -->
            <Group :groupList="loot" :childList="loot.group" :isLoot="true">
            </Group>
            <!-- 타겟 하위 타겟 -->
            <Loot :lootList="loot" :childList="loot.loot"> </Loot>
        </div>
    </div>
</template>
